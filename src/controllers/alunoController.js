import AlunoModel from '../models/ExemploModel.js';
...
export const atualizar = async (req, res) => {
    try {
        ...
        res.status(200).json({ message: `O registro "${data.nome}" foi atualizado com sucesso!`, data });
    } catch (error) {
...
export const deletar = async (req, res) => {
    try {
        ...
        res.status(200).json({ message: `O registro "${aluno.nome}" foi deletado com sucesso!`, deletado: aluno });
    } catch (error) {
